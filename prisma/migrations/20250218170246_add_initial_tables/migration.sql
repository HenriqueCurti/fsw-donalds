...
CREATE TABLE "Order" (
    ...
    "restaurantId" TEXT NOT NULL,
    "consumptionMetod" "ConsumptionMethod" NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "MenuCategory" ADD CONSTRAINT "MenuCategory_retaurantId_fkey" FOREIGN KEY ("retaurantId") REFERENCES "Restaurant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
